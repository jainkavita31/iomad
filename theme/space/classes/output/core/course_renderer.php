...
use theme_space\output\core_renderer as space_core_renderer;
...
class course_renderer extends \core_course_renderer {
    ...
    /**
     * Cached instance of the theme core renderer for fallback assets.
     *
     * @var space_core_renderer|null
     */
    protected $themecorerenderer = null;

    /**
     * Returns the theme core renderer ensuring theme defaults are respected.
     *
     * @return space_core_renderer
     */
    protected function get_theme_core_renderer(): space_core_renderer {
        if ($this->themecorerenderer === null) {
            $this->themecorerenderer = new space_core_renderer($this->page, $this->target);
        }

        return $this->themecorerenderer;
    }
        ...
        if ($totalcount > count($courses)) {
            ...
            if ($paginationurl) {
                ...
                if ($paginationallowall) {
                    ...
                    ), ['class' => 'paging paging-showall text-center mb-4']);
                }
    ...
    protected function coursecat_category(coursecat_helper $chelper, $coursecat, $depth) {
        ...
        $icon = '<svg class="mr-1" width="14" height="14" fill="none" viewBox="0 0 24 24" role="img" aria-label="' . get_string('courses') . '">
