...
$string['accessiblebtnfocus'] = 'Accessible Buttons (Beta version)';
...
$string['pluginname'] = 'Space (2.5.37 Legacy)';
...
$string['skip-links-description'] = 'Use these links to quickly skip to key areas of the page.';
$string['skip-links-sidebar-navigation-menu'] = 'Skip to sidebar navigation menu';
$string['skip-links-topbar-navigation-menu'] = 'Skip to top bar navigation menu';
$string['skip-links-page-footer'] = 'Skip to page footer';
$string['skip-links-page-header'] = 'Skip to page header';
$string['skip-links-blocks-sidebar'] = 'Skip to sidebar hidden blocks';
$string['skip-links-mobile-navigation-menu'] = 'Skip to mobile navigation menu';
$string['wcagskiplinks'] = 'WCAG Skip Links';
$string['wcagskiplinks_desc'] = 'The WCAG Skip Links feature improves accessibility by allowing users to quickly navigate to key sections of the page using keyboard shortcuts. This is especially useful for screen reader users and those who rely on keyboard navigation. Enabling skip links enhances usability, supports compliance with WCAG guidelines, and ensures a more inclusive experience for all users.';

$string['wcagsidenav'] = 'WCAG Sidebar Navigation';
$string['wcagsidenav_desc'] = 'WCAG Sidebar Navigation settings help ensure your site is accessible to all users. These settings enhance keyboard navigation, improve screen reader compatibility, and provide better visual focus indicators. Enabling these features helps your site meet accessibility standards and provides a better experience for users with disabilities.';
$string['wcagmobilenav'] = 'WCAG Mobile Navigation';
$string['wcagmobilenav_desc'] = 'WCAG Mobile Navigation settings help ensure your site is accessible to all users. These settings enhance keyboard navigation, improve screen reader compatibility, and provide better visual focus indicators. Enabling these features helps your site meet accessibility standards and provides a better experience for users with disabilities.';
$string['wcagskiplinksdescription'] = 'WCAG Skip Links Description';
$string['wcagskiplinksdescription_desc'] = '';

$string['wcagtopbarnav'] = 'WCAG Top Bar Navigation';
$string['wcagtopbarnav_desc'] = 'WCAG Top Bar Navigation settings help ensure your site is accessible to all users. These settings enhance keyboard navigation, improve screen reader compatibility, and provide better visual focus indicators. Enabling these features helps your site meet accessibility standards and provides a better experience for users with disabilities.';
$string['wcagblockssidebar'] = 'WCAG Sidebar Blocks';
$string['wcagblockssidebar_desc'] = 'WCAG Sidebar Blocks settings help ensure your site is accessible to all users. These settings enhance keyboard navigation, improve screen reader compatibility, and provide better visual focus indicators. Enabling these features helps your site meet accessibility standards and provides a better experience for users with disabilities.';

$string['wcagpagefooter'] = 'WCAG Page Footer';
$string['wcagpagefooter_desc'] = 'WCAG Page Footer settings help ensure your site is accessible to all users. These settings enhance keyboard navigation, improve screen reader compatibility, and provide better visual focus indicators. Enabling these features helps your site meet accessibility standards and provides a better experience for users with disabilities.';

$string['wcagblocksmain'] = 'WCAG Main Blocks';
$string['wcagblocksmain_desc'] = 'WCAG Main Blocks settings help ensure your site is accessible to all users. These settings enhance keyboard navigation, improve screen reader compatibility, and provide better visual focus indicators. Enabling these features helps your site meet accessibility standards and provides a better experience for users with disabilities.';

$string['settingswcag'] = 'WCAG';
$string['hwcag'] = 'WCAG';
$string['hwcag_desc'] = 'Web Content Accessibility Guidelines (WCAG) settings help ensure your site is accessible to all users. These settings enhance keyboard navigation, improve screen reader compatibility, and provide better visual focus indicators. Enabling these features helps your site meet accessibility standards and provides a better experience for users with disabilities.';
...
&lt;p&gt;Space (2.5.37) is here!&lt;br&gt;&lt;a href=&quot;#&quot; target=&quot;_blank&quot;&gt;Get this theme today!&lt;/a&gt;
&lt;/p&gt;
&lt;/div&gt;</pre>';
...
$string['hintro'] = '<img src="{$a->siteurl}/theme/space/doc/theme-icon.svg" class="img-fluid rounded my-3" width="80" height="80" alt="space Moodle Theme" /><div class="lead-3">Space for Moodle 4.5 LTS</div>';
$string['hintro_desc'] = '
<div class="mt-1 small">by <a href="https://rosea.io">RoseaThemes</a></div><hr class="mt-3" />
<div class="mt-3"><span class="badge badge-light">Version: 2.5.37</span></div>
...
$string['magicadmintool'] = 'Magic Admin Tool';
$string['magicadmintool_desc'] = 'Enable or disable the import/export settings tool to manage theme settings.
<br /><strong>This tool provides:</strong>
<ul>
<li>Export functionality to save your current theme settings</li>
<li>Import capability to load settings into another Moodle instance</li>
<li>All settings are exported as a JSON file</li>
<li><strong>Images and other files are not included in the export</strong></li>
</ul>';
