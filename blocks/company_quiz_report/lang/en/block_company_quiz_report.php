...
$string['statusersattempted'] = 'Attempts';
$string['statusersattempted_hint'] = 'Quiz attempts in company courses';
$string['statusersfailed'] = 'Proctor-failed attempts';
$string['statusersfailed_hint'] = 'Auto-submitted attempts by ProctorLink';
